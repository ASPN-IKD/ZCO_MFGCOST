sap.ui.define([
    "zcomcs/controller/BaseController",
    "sap/ui/model/Sorter",
    ...
    return Controller.extend("zcomcs.controller.Main", {
        onInit: function() {
            oView = this.getView();
        ...
        setInitPage : function(oView){
            ...
            //value help list
            var oLedger = this._setCustomModel(_oDataList, oView, "oLedger", "/sap/opu/odata/sap/ZUI_CO_MFGCOST_O2/", "/Ledger", "JSONModel");
            var oCompany = this._setCustomModel(_oDataList, oView, "oCompany", "/sap/opu/odata/sap/ZUI_CO_MFGCOST_O2/", "/Company", "JSONModel");
            var oPlant = this._setCustomModel(_oDataList, oView, "oPlant", "/sap/opu/odata/sap/ZUI_CO_MFGCOST_O2/", "/Plant", "JSONModel");
            _oGLAccount = this._setCustomModel(_oDataList, oView, "oGLAccount", "/sap/opu/odata/sap/ZUI_CO_MFGCOST_O2/", "/GLAccount", "JSONModel");
        ...
        onSearch : function(){
            ...
            if (!aFilter.length || aFilter.length != 4){
                MessageToast.show(_i18n.getText("MSG_RESULT_FILTER"));
                _oTable.setBusy(false);
                return;
            }
        
            var url = "/ZR_CO_MFGCOST_01(P_Ledger='" + aFilter[0] + "',P_Companycode='" + aFilter[1] + "',P_Plant='" + aFilter[2] + "',P_FiscalYearPeriod='" + aFilter[3] + "',P_Type='1')/Set"
            
            _oModelMain = this._setCustomModel(_oDataList, oView, "oMODELMAIN", "/sap/opu/odata/sap/ZUI_CO_MFGCOST_O2/", url, "ODataModel");
